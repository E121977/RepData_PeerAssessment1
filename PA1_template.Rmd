...
_**The mean number of steps taken per day is `r mean.steps`**_  
_**The median number of steps taken per day is `r median.steps`**_
...
_**The average maximum number of steps taken (`r max.average.steps`) occurs during the 5-minute interval starting at the `r data.most.active.interval`th minute of each daily cycle.  NOTE: Each daily 5 min cycle begins at "0" and ends at "2055".**_ 
...
```
_**The total number of missing values in the dataset represented by "NA" is `r missing.values` **_
...
_**The new mean number of steps taken per day is `r new.mean.steps` **_

_**The new median number of steps taken per day is `r new.median.steps`**_
